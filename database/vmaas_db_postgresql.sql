...
CREATE TABLE IF NOT EXISTS errata (
  ...
  solution TEXT NULL, CHECK (NOT empty(solution)),
...
CREATE TABLE IF NOT EXISTS cve (
  ...
  iava TEXT NULL, CHECK (NOT empty(iava)),
  redhat_url TEXT NULL, CHECK (NOT empty(redhat_url)),
  secondary_url TEXT NULL, CHECK (NOT empty(secondary_url)),
  PRIMARY KEY (id),
  CONSTRAINT severity_id
    FOREIGN KEY (severity_id)
    REFERENCES severity (id)
